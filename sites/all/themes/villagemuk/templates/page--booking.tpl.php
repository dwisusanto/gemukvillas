...
$node1 = node_load(1, NULL, TRUE);
$node1_view = node_view($node1);
$node13 = node_load(13, NULL, TRUE);
$node13_view = node_view($node13);
							...
							<tr>
								...
								<td>
									<select id="edit-rooms" name="rooms" class="form-select ajax-processed">
										<option value="1" selected="selected">Villa gemuk 2 bed room</option>
										<option value="2">Villa gemuk 3 bed room</option>
                    <option value="3">Villa gemuk deluxe 2 bed room</option>
